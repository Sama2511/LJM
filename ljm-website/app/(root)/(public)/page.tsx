      ...
      <section className="@container mt-6">
        <div className="flex flex-col @[1000]:flex-row @[1000]:items-center gap-6">
          ...
          <div className="flex w-full flex-col items-center text-center @[630]:items-start @[630]:pt-6 @[630]:pl-7 @[700]:pl-15 @[1000]:w-1/2 @[1000]:pl-20 @[1600]:pl-50">
            ...
            {/* Hero Description */}
            <p className="text-foreground/80 mt-3 max-w-[90%] text-center font-sans text-base @[630]:max-w-[85%] @[630]:text-left @[800]:text-lg @[1000]:max-w-[80%] @[1000]:text-xl @[1200]:max-w-[75%]">
            ...
            {/* Hero Buttons */}
            <div className="mt-4 flex justify-center gap-4 @[630]:mt-6 @[630]:flex-col @[700]:flex-row @[700]:justify-start @[800]:w-full @[1000]:mb-8">
              <Button asChild>
                <Link
                  href="/donation"
