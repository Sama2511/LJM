  ...
  return (
    <>
      <Card className="flex w-[350px] gap-2 border-1 border-black bg-[#E2DFDA]">
        ...
        <CardContent>
          <CardTitle className="mb-1 text-3xl text-[#3E5F44]">
            {title}
          </CardTitle>
          <div className="mb-3 flex items-center gap-1 text-[15px]">
            <MapPin className="size-4" />
            {location}
          </div>
          <CardDescription className="my-5 line-clamp-3 text-[15px]">
            {description}
          </CardDescription>
        </CardContent>
